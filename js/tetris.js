class Game {
    ...
    showWelcome() {
        Swal.fire("Bienvenido", `Clone de Tetris hecho en Javascript.
<br><br>
...
<strong>Creado por <a href="https://alanmgg.netlify.app/" target="_blank">Alan Francisco Mora</a></strong>
<br>
`);
    }
    ...
    initSounds() {
        this.sounds.background = Utils.loadSound("assets/Strange to me.mp3", true);
